...
export function SearchBar({ query, setQuery, loading, error, titleLanguage = 'english', onTitleLanguageToggle }: SearchBarProps) {
  const isJapanese = titleLanguage === 'japanese';
